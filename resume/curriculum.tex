...
\cvskill
{Computação} % Category
{C/C++, JAVA, Python, Octave (Matlab), Ruby, Rails, LaTeX, MySQL, Linux, Arduino, Shell, Git, OpenGL, Android Studio, Unity, Vim.} % Skills
